...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 15:06:00 GMT -->
...
<body>
    ...
    <div class="wrapper">
                        ...
                        <?php if (isset($_SESSION['user_admin'])) : ?>
                            <div class="dropdown topbar-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item text-danger" href="index.php?act=logout_admin">
        ...
        <div class="main-nav">
            <!-- Sidebar Logo -->
            <div class="logo-box">
                <a href="index.php?act=dashboard" class="logo-dark">
                ...
                <a href="index.php?act=dashboard" class="logo-light">
                    <img src="assets_admin/images/logo-sm.png" class="logo-sm" alt="logo sm">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarCoupons">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=coupons">List</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=add_coupon">Add</a>
                                </li>
                            </ul>
                        </div>
                    </li>
