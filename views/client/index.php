    ...
    <section class="tp-product-category pt-60 pb-15">
        <div class="container">
            <div class="row row-cols-xl-5 row-cols-lg-5 row-cols-md-4">
                <!--                $limitCategories = 3;-->
                <!--                $limitCate  = array_slice($categories, 0, $limitCategories); // Cắt mảng theo số lượng mong muốn-->
                <!--                -->
                        ...
                        <div class="tp-product-category-item text-center mb-40">
                            <div class="tp-product-category-thumb fix">
                                <a href="shop-category.html">
                                    <img src="./images/category/<?= $cate['image'] ?>" alt="product-category">
                                </a>
                            </div>
                                            ...
                                            <div class="tp-product-item p-relative transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    ...
                                                    <div class="tp-product-action">
                                                        <div class="tp-product-action-item d-flex flex-column">
                                                            ...
                                                            <a type="button" href="index.php?act=addFavorite&&product_id=<?=$pro['product_id']?>" class="tp-product-action-btn tp-product-add-to-wishlist-btn">
                                                ...
                                                <div class="tp-product-content">
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <span class="tp-product-price old-price" hidden></span>
                                                        <span class="tp-product-price new-price">$<?= $pro['product_price'] ?> to ...</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php foreach ($products as $pro) : ?>
                                    <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                        ...
                                        <div class="tp-product-content">
                                            ...
                                            <div class="tp-product-price-wrapper">
                                                <!-- <span class="tp-product-price old-price">$475.00</span> -->
                                                <span class="tp-product-price new-price">$<?= $pro['product_price'] ?>.00</span>
                                            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                            <?php
                            $desiredLimit = 3; // Đặt số lượng sản phẩm mong muốn hiển thị
                            $limitedProducts = array_slice($products, 0, $desiredLimit); // Cắt mảng theo số lượng mong muốn
                            ?>
                            <?php foreach ($limitedProducts as $product) : ?>
                                <div class="tp-product-sm-item d-flex align-items-center">
                                    ...
                                    <div class="tp-product-sm-content">
                                        ...
                                        <div class="tp-product-price-wrapper">
                                            <span class="tp-product-price">$<?= number_format($product['product_price']) ?>.00</span> </span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
