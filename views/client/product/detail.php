                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                            ...
                            <span><a href="index.php?act=index">Home</a></span>
                        ...
                        <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <?php foreach ($productDetail['gallery_images'] as $key => $galleryImage) : ?>
                                        <button class="nav-link <?= $key === 0 ? 'active' : '' ?>" id="nav-<?= $key + 1 ?>-tab" data-bs-toggle="tab" data-bs-target="#nav-<?= $key + 1 ?>" type="button" role="tab" aria-controls="nav-<?= $key + 1 ?>" aria-selected="<?= $index === 0 ? 'true' : 'false' ?>">
                                            <img src="./images/productGalery/<?= $galleryImage ?>" alt="">
                                        </button>
                                    <?php endforeach; ?>
                                </div>
                            </nav>
                        ...
                        <form action="index.php?act=addToCart" method="post">
                            ...
                            <div class="tp-product-details-wrapper">
                                ...
                                <div class="tp-product-details-price-wrapper mb-20">
                                    <span class="tp-product-details-price old-price old-price-variants">$<?= $productDetail['product_price'] ?>.00</span>
                                    <span class="tp-product-details-price new-price new-price-variants">$<?= $productDetail['product_sale_price'] ?>.00</span>
                                ...
                                <div class="tp-product-details-variation">
                                    ...
                                    <div class="tp-product-details-variation-item">
                                        ...
                                        <div class="tp-product-details-variation-list">
                                            <?php foreach ($uniqueColors as $color) : ?>
                                                <button type="button" class="variants-color tp-color-variation-btn " data-color="<?= $color['color_code'] ?>">
                                                    <span class="border" data-bg-color="<?= $color['color_code'] ?>"></span>
                                        ...
                                        <div class="tp-product-details-variation-item">
                                            ...
                                            <div class="tp-product-details-variation-list">
                                                <?php foreach ($uniqueSizes as $size) : ?>
                                                    <button type="button" class="variants-size tp-size-variation-btn " data-size="<?= $size ?>">
                                                        <span><?= $size ?></span>
                                                    </button>
                                                <?php endforeach; ?>
                                            </div>
                                    ...
                                    <div class="tp-product-details-action-wrapper">
                                        <h3 class="tp-product-details-action-title variant-quantity">Quantity</h3>
                                        <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                            <div class="tp-product-details-quantity">
                                                <div class="tp-product-quantity mb-15 mr-15">
                                                    ...
                                                    <input class="tp-cart-input" name="quantity" type="text" value="1">
                                            ...
                                            <div class="tp-product-details-add-to-cart mb-15 w-100">
                                                <button class="tp-product-details-add-to-cart-btn w-100" name="addToCart" type="submit">Add To Cart</button>
                                            </div>
                                        </div>
                                        <button class="tp-product-details-buy-now-btn w-100" type="submit" name="buyNow">Buy Now</button>
                                    </div>
                                    ...
                                    <div class="tp-product-details-query">
                                        ...
                                        <div class="tp-product-details-query-item d-flex align-items-center">
                                            <span>Category: </span>
                                            <p><?= $productDetail['category_name'] ?></p>
                                        </div>
                                        <div class="tp-product-details-query-item d-flex align-items-center">
                                            <span>Tag: </span>
                                            <p>Android</p>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-10">
                                                    <div class="tp-product-details-desc-item pb-105">
                                                        <div class="row">
                                                            <div><?= $productDetail['product_description'] ?></div>
                                                            <!-- <div class="col-lg-6">
