                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="profile__main-logout text-sm-end">
                                                        <a href="index.php?act=logout" class="tp-logout-btn">Logout</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <select name="gender">
                                                                    <option value="male" <?= $_SESSION['user']['gender'] == 'male' ? 'selected' : '' ?>>
                                                                        Male
                                                                    </option>
                                                                    <option value="female" <?= $_SESSION['user']['gender'] == 'female' ? 'selected' : '' ?>>
                                                                        Female
                                                                    </option>
                                                                    <option value="others" <?= $_SESSION['user']['gender'] == 'others' ? 'selected' : '' ?>>
                                                                        Others
                                                                    </option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="profile__btn">
                                                            <button name="updateProfile" type="submit" class="tp-btn">
                                                                Update Profile
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($orders as $order) : ?>
                                                    <tr>
                                                        ...
                                                        <td data-info="title">$<?= $order['amount'] ?>.00</td>
                                                        <td data-info="status pending"><?= $order['status'] ?></td>
                                                        <td><a href="index.php?act=track_order&id=<?= $order['id'] ?>" class="tp-logout-btn">Invoice</a></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
