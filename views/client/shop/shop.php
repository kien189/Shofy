                                ...
                                <div class="tp-shop-widget-categories">
                                    <ul>
                                        <?php foreach ($data['categories'] as $cate) : ?>
                                            <li>
                                                <?php if ($data['countCate'][$cate['id']] > 0): ?>
                                                    <a href="index.php?act=shop&category_id=<?= $cate['id'] ?>"><?= $cate['name'] ?>
                                                        <span><?= $data['countCate'][$cate['id']] ?></span>
                                                    </a>
                                                <?php else: ?>
                                                    <a><?= $cate['name'] ?>
                                                        <span><?= $data['countCate'][$cate['id']] ?></span>
                            ...
                            <div class="tab-content" id="productTabContent">
                                <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                    <div class="row infinite-container">
                                        <?php if (!empty($data['searchProduct'])): ?>
                                            <p>Kết quả tìm kiếm cho từ khoá '<?= $_SESSION['keyword'] ?>'</p>
                                            <?php foreach ($data['searchProduct'] as $pro) : ?>
                                                    ...
                                                    <div class="tp-product-item-2 mb-40">
                                                        ...
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <h3 class="tp-product-title-2">
                                                                <a href="index.php?act=product_detail&slug=<?= $pro['product_slug'] ?>"><?= $pro['product_name'] ?></a>
                                                            </h3>
                                                            ...
                                                            <div class="tp-product-price-wrapper-2">
                                                                <span class="tp-product-price-2 new-price">$<?= $pro['product_price'] ?>.00</span>
                                                                <span class="tp-product-price-2 old-price">$<?= $pro['product_sale_price'] ?>.00</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
                                        <?php elseif (!empty($getProductByCate)): ?>

                                            <p>Kết quả tìm kiếm cho từ khoá '<?= $getProductByCate[0]['category_name'] ?>'</p>
                                            <?php foreach ($getProductByCate as $pro) : ?>
                                                <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                    <div class="tp-product-item-2 mb-40">
                                                        <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                            <a href="product-details.html">
                                                        ...
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <div class="tp-product-price-wrapper-2">
                                                                <span class="tp-product-price-2 new-price">$<?= $pro['product_price'] ?>.00</span>
                                                                <span class="tp-product-price-2 old-price">$<?= $pro['product_salePrice'] ?>.00</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="tp-product-list-item d-md-flex">
                                                            ...
                                                            <div class="tp-product-list-content">
                                                                <div class="tp-product-content-2 pt-15">
                                                                    ...
                                                                    <div class="tp-product-price-wrapper-2">
                                                                        <span class="tp-product-price-2 new-price">$<?= $pro['product_price'] ?>.00</span>
                                                                        <span class="tp-product-price-2 old-price">$<?= $pro['product_price'] ?>.00</span>
                                                                    </div>
                                                                    ...
                                                                    <div class="tp-product-list-add-to-cart">
                                                                        <a href="index.php?act=product_detail&slug=<?= $pro['product_slug'] ?>" class="tp-product-list-add-to-cart-btn">Add To Cart</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; ?>
                                                <?php elseif ($getProductByCate): ?>
                                                    <?php foreach ($getProductByCate as $pro) : ?>
                                                        <p>Kết quả tìm kiếm cho từ khoá '<?= $pro['category_name'] ?>'</p>
                                                        <div class="tp-product-list-item d-md-flex">
                                                            <div class="tp-product-list-thumb p-relative fix">
                                                                <a href="index.php?act=product_detail&slug=<?= $pro['product_slug'] ?>">
                                                                    <img src="./images/product/<?= $pro['product_image'] ?>" alt="">
                                                            ...
                                                            <div class="tp-product-list-content">
                                                                <div class="tp-product-content-2 pt-15">
                                                                    ...
                                                                    <div class="tp-product-price-wrapper-2">
                                                                        <span class="tp-product-price-2 new-price">$<?= $pro['product_salePrice'] ?>.00</span>
                                                                        <span class="tp-product-price-2 old-price">$<?= $pro['product_price'] ?>.00</span>
                                                                    </div>
                                                                    <p>Auctor urna nunc id cursus. Scelerisque purus semper eget duis at pharetra vel turpis nunc eget.</p>
                                                                    <div class="tp-product-list-add-to-cart">
                                                        ...
                                                        <div class="tp-product-list-item d-md-flex">
                                                            ...
                                                            <div class="tp-product-list-content">
                                                                <div class="tp-product-content-2 pt-15">
                                                                    ...
                                                                    <div class="tp-product-price-wrapper-2">
                                                                        <span class="tp-product-price-2 new-price">$<?= $pro['product_sale_price'] ?>.00</span>
                                                                        <span class="tp-product-price-2 old-price">$<?= $pro['product_price'] ?>.00</span>
                                                                    </div>
                                                                    <p>Auctor urna nunc id cursus. Scelerisque purus semper eget duis at pharetra vel turpis nunc eget.</p>
                                                                    <div class="tp-product-list-add-to-cart">
