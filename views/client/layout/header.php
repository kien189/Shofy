...
<![endif]-->
    ...
    //    var_dump($cartProvider->getCartItems());
    $carts = $cartProvider->getCartItems();
    $favorite = $cartProvider->getFavoriteItems();
    $sum = $cartProvider->sum($carts);
    //     echo '<pre>'; print_r(count($favorite)); echo '</pre>';
    ...
    <div id="tp-bottom-menu-sticky" class="tp-mobile-menu d-lg-none">
        <div class="container">
            <div class="row row-cols-5">
                ...
                <div class="col">
                    <div class="tp-mobile-item text-center">
                        <a href="index.php?act=favorite" class="tp-mobile-item-btn">
                    ...
                    <?php foreach ($carts as $cart) : ?>
                        <div class="cartmini__widget-item">
                            ...
                            <div class="cartmini__content">
                                <h5 class="cartmini__title"><a href="product-details.html"><?= $cart['product_name'] ?></a>
                                </h5>
                            ...
                            <a href="index.php?act=removeCart&cartId=<?= $cart['cart_id'] ?>" class="cartmini__del"><i
                            ...
                            <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                ...
                                <div class="tp-header-top-menu-item tp-header-setting">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="index.php?act=favorite">Wishlist</a>
                                        </li>
                                        <li>
                                ...
                                <form action="index.php?act=shop" method="post">
                                    <div class="tp-header-search-wrapper d-flex align-items-center">
                                        ...
                                        <div class="tp-header-search-btn">
                                            <button name="searchProduct" type="submit">
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                            <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                <div class="tp-header-login d-none d-lg-block">
                                    <?php if (isset($_SESSION['user'])): ?>
                                        <a href="index.php?act=profile" class="d-flex align-items-center">
                                        <?php else: ?>
                                            <a href="index.php?act=login" class="d-flex align-items-center">
                                            <?php endif; ?>
                                            <div class="tp-header-login-icon" style="overflow: hidden;">
                                                <span>
                                                        <img style="width: 35px;object-fit: cover;border-radius: 50%;" style="object-fit: cover;" src="<?= !empty($_SESSION['user']['avatar']) ? './images/user/' . $_SESSION['user']['avatar'] : 'https://i.pinimg.com/1200x/bc/43/98/bc439871417621836a0eeea768d60944.jpg' ?>" alt="User Avatar">
                                ...
                                <div class="tp-header-action d-flex align-items-center ml-50">
                                    ...
                                    <div class="tp-header-action-item d-none d-lg-block">
                                        <a href="index.php?act=favorite" class="tp-header-action-btn">
                                            ...
                                            <!-- <span class="tp-header-action-badge">< count($favorite)  ?></span> -->
                                        </a>
                                    </div>
                                    <div class="tp-header-action-item">
                                        <!-- <button type="button" class="tp-header-action-btn cartmini-open-btn"> -->
                                        <a href="index.php?act=cart" type="button" class="tp-header-action-btn">
                        ...
                        <div class="tp-header-action d-flex align-items-center justify-content-end ml-50">
                            ...
                            <div class="tp-header-action-item d-none d-lg-block">
                                <a href="index.php?act=favorite" class="tp-header-action-btn">
                                    ...
                                    <!-- <span class="tp-header-action-badge">< count($favorite) ?? 0 ?> </span> -->
                                </a>
                            </div>
                            <div class="tp-header-action-item">
